        ...
        <div className="glass rounded-2xl p-8">
          ...
          {status === "success" && (
            <div className="text-center space-y-4">
              ...
              <Link to="/optimiser"
                className="inline-flex items-center justify-center w-full h-12 bg-[var(--raven)] hover:bg-[var(--raven-glow)] text-white rounded-xl font-semibold text-sm transition-all">
